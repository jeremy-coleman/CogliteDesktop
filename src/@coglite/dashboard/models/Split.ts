...
export class SplitModel extends ComponentModel implements ISplit {
...
export class HSplitModel extends SplitModel implements IHSplit {
...
export class VSplitModel extends SplitModel implements IVSplit {
